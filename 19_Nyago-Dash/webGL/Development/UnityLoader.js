...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 41613182;
      var PACKAGE_UUID = 'a1ae08a9-ed9c-4159-bf2f-0a6af3665c83';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 22, 0, 0).open('GET', '/PlayerConnectionConfigFile');
    new DataRequest(22, 111386, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(111386, 129494, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(129494, 278474, 0, 0).open('GET', '/level0');
    new DataRequest(278474, 278728, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(278728, 285181, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(285181, 28214197, 0, 0).open('GET', '/resources.assets');
    new DataRequest(28214197, 38576141, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(38576141, 40621833, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(40621833, 41508757, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(41508757, 41585557, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(41585557, 41613182, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
