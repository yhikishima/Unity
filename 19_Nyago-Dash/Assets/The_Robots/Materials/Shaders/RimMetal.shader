Shader "RimLighting"
{
	Properties 
	{
_diffuse_colour("_diffuse_colour", Color) = (1,1,1,1)
_diffuse_multiply("_diffuse_multiply", Range(0,2) ) = 2
...
_specular("_specular", Range(1,0.1) ) = 0.1
...
float4 Multiply2=_diffuse_colour * _diffuse_multiply.xxxx;
float4 Multiply1=Tex2D0 * Multiply2;
